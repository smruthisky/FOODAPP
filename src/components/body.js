...
import {userContext} from "../utils/useContext.js";
 const Body=()=>{
    ...
    return allresturants.length ===0 ?( 
      ...
      <div data-testid="shimmer" className="allskeleton  flex flex-wrap ml-8 mt-4 mr-2" >
...
<div className="resturant-list   mt-3 h-80 ml-8  flex flex-wrap" data-testid="res-list">   
